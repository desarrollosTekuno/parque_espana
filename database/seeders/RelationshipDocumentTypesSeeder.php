    ...
    public function run(): void
    {
        ...
        $relationshipDocumentTypes = [
            [
                ...
                'documents' => ['acta_nacimiento_espanola', 'acta_matrimonio', 'acta_nacimiento', 'fotografia_infantil', 'constancia_trabajo', 'constancia_estudios', 'carta_recomendacion', 'ine', 'comprobante_domicilio', 'formato_datos_clinicos', 'carta_no_adeudo', 'recibo_pe1_sin_adeudo'],
            ],
            [
