    ...
    public function run(): void
    {
        ...
        $relationshipDocumentTypes = [
            [
                ...
                'documents' => ['acta_nacimiento_espanola', 'acta_matrimonio', 'acta_nacimiento', 'fotografia_infantil', 'constancia_trabajo', 'carta_recomendacion', 'ine', 'comprobante_domicilio', 'carta_no_adeudo', 'recibo_pe1_sin_adeudo', 'carta_doctor_activo','formato_solicitud_usuario'],
            ],
            [
