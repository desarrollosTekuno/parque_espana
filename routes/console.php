...
use App\Console\Commands\MarkReservationNoShows;
...
Schedule::command(ExpireDailyPassCards::class)->everyFifteenMinutes();Schedule::command(MarkReservationNoShows::class)->everyMinute();
