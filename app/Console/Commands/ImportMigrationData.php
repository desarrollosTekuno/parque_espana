...
class ImportMigrationData extends Command
{
    /* 
    Ejemplo de uso:
    php artisan migrate:data C:\Users\Usuario\Documents\webApps\parque_espana\public\Plantilla_Migracion_Casos_Prueba_tmp.xlsx --only=usuarios,membresias,integrantes,domicilios,empleo,"historial por periodo",casilleros --dry-run
    */
