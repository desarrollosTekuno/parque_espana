...
class AnnouncementController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return Inertia::render('AdminClubs/Announcements/Index', [
        ...
        try {
            ...
            if ($request->hasFile('images')) {
                foreach ($request->file('images') as $file) {
                    $path = $this->uploadGalleryImage($file, $clubId);
    ...
    private function uploadImage(\Illuminate\Http\UploadedFile $file, int|string $clubId): string
    {
        ...
        $directory = "clubs/{$clubCode}/announcements";
    ...
    private function uploadGalleryImage(\Illuminate\Http\UploadedFile $file, int|string $clubId): string
    {
        $clubCode  = \App\Models\Administrator\Club::find($clubId)?->code ?? $clubId;
        $directory = "clubs/{$clubCode}/announcements/gallery";
        $filename  = Str::uuid() . '.' . $file->getClientOriginalExtension();
