...
@section('header', 'Actualizacion de estatus')

@section('content')
    <p style="margin-bottom: 18px;">
        Tu ticket tuvo una actualizacion de estatus.
    </p>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 18px; border: 1px solid #e2e8f0; border-radius: 10px; overflow: hidden;">
        ...
        <tr>
            <td style="padding: 10px 12px; border-top: 1px solid #e2e8f0; color: #334155; font-weight: 700;">Nuevo estatus</td>
            <td style="padding: 10px 12px; border-top: 1px solid #e2e8f0; color: #0f172a;">{{ $ticket->status->name ?? 'N/A' }}</td>
        </tr>
        <tr>
            <td style="padding: 10px 12px; border-top: 1px solid #e2e8f0; color: #334155; font-weight: 700;">Fecha de actualizacion</td>
            <td style="padding: 10px 12px; border-top: 1px solid #e2e8f0; color: #0f172a;">{{ optional($ticket->updated_at)->format('d/m/Y H:i') }}</td>
        </tr>
    </table>
